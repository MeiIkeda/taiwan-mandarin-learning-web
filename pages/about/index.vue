  ...
  -->
    <div class="main-text">
      ...
      <p>
        ...
        <br>
        台湾華語を学ぶにあたって、繁体字の学習教材が少ないなと感じた事が、本サイトを制作するきっかけでした。<br>
        本サイトには、単語聞き流しをはじめ、学習においてあると便利な機能を盛り込んでいきます。<br>
        単語情報等には、広く使用される簡体字もなるべく併記するようにしますが、「台湾華語」という名の通り、<br>
        台湾独特の言い回しなども将来的に多く含めていけたらと思っています。<br>
