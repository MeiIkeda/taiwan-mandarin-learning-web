    ...
    <div align="center">
      ...
      <table class="table-bordered" style="align: center; text-align: left">
        ...
        <p>
          ...
          <span style="color: red">※お使いのブラウザやバージョンによっては、音声再生に対応していない場合があります。
            推奨ブラウザはGoogle Chromeです。</span>
          <br>
        </p>
        <p style="font-weight: bold">
          3). 聞き流し
        ...
        <p>
          「AutoStart」を押すと、単語リストを自動再生します。「AutoStop」で、自動再生を終了します。<br>
          <span style="color: red">※お使いのブラウザやバージョンによっては、音声再生に対応していない場合があります。
            推奨ブラウザはGoogle Chromeです。</span>
        </p>
        <p>
        ...
        <p>
          日本語においては、1つの漢字が複数の読み方を持つのが普通です。<br>
          しかし中国語では、例外はあるものの基本的に読み方は1つです。
          したがって、例えば「台湾」という単語の読み方さえ覚えれば、別の場面で「台」や「湾」という漢字が出てきた時、意味は分からなかったとしても、 少なくとも読む事ができます。<br>
          「漢字の並びで大体の意味は推測できるが、読めない」状態だと、文章として記憶する事は難しいです。<br>
          聞き流しの一番の効果は、各漢字の読み方を、スピーディに効率よく頭に入れられる事だと思います。<br>
          繰り返し聞けばよりしっかりと記憶する事ができますので、大まかな読み方→ボポモフォ/ピンインの書き方→意味というように、 少しづつ段階を踏んで覚えていくのが個人的にはお勧めです。<br>
        </p>
        <p style="font-weight: bold">
          発音記号(=ボポモフォ/ピンインと声調記号)は覚えるべきか?
        </p>
        <p>
          結論から言えば、発音記号は覚えておいた方が良いと思います。<br>
          発音記号がわからないとパソコンやスマホで文章が打てない事も理由の1つですが、やはり一番は、中国語の発音の難しさでしょうか。<br>
          発音を聞いて繰り返し呟けば、単語を「一時的に」覚えることはできます。<br>
          しかし、音の記憶は非常に感覚的なものですし、中国語はとりわけ日本語ネイティブの苦手とする発音を多用します。
          発音記号という符号に頼らない限り、音だけで長期的に記憶する事は困難です。<br>
          本サイトではボポモフォをお勧めしておりますが、ピンインでも大丈夫ですので、声調と一緒に暗記しておく事をお勧めします。<br>
        </p>
      </div>
    </div>
    <!--    <head>-->
